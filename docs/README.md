...
## Aktueller Stand (2026-08-05, Regelwerk v0.3.3 / Modell v0.2.1 mit v0.3-Erweiterungen / Engine v0.3.6 / Kartenpool 300 Karten + 3 Token-Definitionen / Frontend v0.1.36 / KI-Gegner v2.3, **die letztgenannten Schritte (Frontend v0.1.35+v0.1.36, KI v2.3 inkl. des darin bereits enthaltenen v2.2-Lethal-Checks) noch uncommitted**)
...
zusammen **229 Einzeltests grün + 1 bewusst übersprungener Analyse-Test,
über 50 von 51 Testdateien, über Engine+UI+KI** —
**documenter-Korrektur 2026-08-05 (v0.1.36-Sweep, „Spielspeicher in der
Partie"):** diese Zeile trug zuvor die v0.1.35-Zahl 221/221+1 über 47/48
Testdateien; der neue v0.1.36-Schritt (eine neue UI-Testdatei,
`game-save.test.ts`, 4 Fälle) plus die bereits vorher dokumentierten, zum
v0.1.35-Sweep noch nicht mitgezählten KI-v2.3-Testdateien
(`hardBot-mana-hold-back.test.ts`/`hardBot-cast-reply.test.ts`, je 2 Fälle)
heben das laut Auftrag zusammen auf 229 grüne Einzeltests über 50 von 51
Testdateien (19 Engine + 7 KI + 25 UI) — per `Glob` gegen den tatsächlichen
Dateibaum gegengezählt (exakte Übereinstimmung), die neue UI-Testdatei
zusätzlich per Grep auf 4 `it(`-Fälle verifiziert (s. „Seit dem letzten
Sweep (2026-08-05, Frontend v0.1.36)" unten), s. „Seit dem letzten
Sweep"-Absätze unten),
Starter-Kartenset (v0.15, 300 Karten + 3 Token-Definitionen), Spielbrett-UI
(**v0.1.36, NOCH NICHT committet**) und ein KI-Gegner mit drei echten
